...
if (netCDF_FOUND)
  ...
  if (NOT TARGET netCDF::netcdf)
    scene_add_library_alias(netCDF::netcdf netcdf)
  endif()
  return()
endif()
...
scene_inspect_netcdf_config(NC_HINTS_INCLUDE_DIR "${NC_CONFIG}" "--includedir")
scene_inspect_netcdf_config(NC_HINTS_PREFIX "${NC_CONFIG}" "--prefix")
