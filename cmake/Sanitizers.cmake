...
function(enable_sanitizers target_name)
  ...
  if(CMAKE_Fortran_COMPILER_ID STREQUAL "GNU" OR CMAKE_Fortran_COMPILER_ID MATCHES ".*Clang")
    ...
    if(ENABLE_COVERAGE)
      ...
      if (fastcov_FOUND AND genhtml_FOUND)
        ...
        set(COVERAGE_MSG "Open file://${CMAKE_CURRENT_BINARY_DIR}/${COVERAGE_NAME}/index.html in your browser to view coverage HTML output")

        add_custom_target(code-coverage-capture
          COMMAND
            fastcov --include "${CMAKE_CURRENT_SOURCE_DIR}"
    ...
    if(ENABLE_SANITIZER_MEMORY AND CMAKE_Fortran_COMPILER_ID MATCHES ".*Clang")
